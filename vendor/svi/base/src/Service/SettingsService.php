...
class SettingsService extends ContainerAware
{
    ...
    {
        return array_keys($this->c->getConfigService()->get('settings'));
    }

    public function getSettingName($key)
    {
        $settings = $this->c->getConfigService()->get('settings');
    ...
    public function updateDatabase()
    {
        ...
        foreach (array_keys($this->c->getConfigService()->get('settings')) as $key) {
            $inDb = null;
            foreach ($exists as $e) {
